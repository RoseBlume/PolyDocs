			...
			sidebar: [
				{
					label: 'Home',
					items: [
						{ label: 'Overview', slug: 'home/overview' },
						{ label: 'Books', slug: 'home/books' }
					]
				},
				{
					...
					items: [
						{
							...
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/Blazor'}
						},
						{
							label: 'Dioxus',
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/Dioxus'}
						},
						{
							label: 'Leptos',
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/Leptos'}
						},
						{
							label: 'React',
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/React'}
						},
						{
							label: 'SolidJS',
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/SolidJS'}
						},
						{
							label: 'Svelte',
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/Svelte'}
						},
						{
							label: 'Vue',
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/Vue'}
						},
						{
							label: 'Yew',
							badge: { text: 'WIP', variant: 'tip' },
							collapsed: true,
							autogenerate: {directory: 'Frontend Frameworks/Yew'}
						}
					]
				},
				{
