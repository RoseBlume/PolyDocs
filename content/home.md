...
<CardGrid>
  <LinkCard title="HTML" href="/High-Level/html/elements">
    Learn the basics of HTML and how to structure web content.
  </LinkCard>
  <LinkCard title="CSS" href="/High-Level/css/basics">
    Discover how to style your web pages with CSS.
  </LinkCard>
  <LinkCard title="JavaScript" href="/High-Level/javascript/variables">
    Understand the fundamentals of JavaScript for dynamic web content.
  </LinkCard>
  <LinkCard title="C#" href="/High-Level/CSharp/data-types">
    Dive into C# programming and build robust applications.
  </LinkCard>
  <LinkCard title="Dart" href="/High-Level/dart/variables">
    Explore Dart language and its applications in Flutter.
  </LinkCard>
  <LinkCard title="Java" href="/High-Level/java/data-types">
    Master Java programming for various applications.
  </LinkCard>
  <LinkCard title="PHP" href="/High-Level/php/data-types">
    Get started with PHP for server-side scripting.
  </LinkCard>
  <LinkCard title="Python" href="/High-Level/python/data-types">
    Learn Python for versatile programming tasks.
  </LinkCard>
  <LinkCard title="R" href="/High-Level/r/basic-syntax">
    Analyze data and perform statistical computing with R.
  </LinkCard>
  <LinkCard title="SQL" href="/High-Level/sql/count">
    Manage and query databases using SQL.
  </LinkCard>
  <LinkCard title="TypeScript" href="/High-Level/typescript/simple-types">
...
## Low Level Languages
<CardGrid>
  <LinkCard title="C" href="/Low-Level/c/Get_Started">
    Learn the fundamentals of C programming for system-level applications.
  </LinkCard>
  <LinkCard title="C++" href="/Low-Level/CPP/Variables">
    Master C++ for performance-critical applications.
  </LinkCard>
  <LinkCard title="NASM" href="/Low-Level/nasm/Basic_Syntax">
    Dive into NASM for low-level assembly programming.
  </LinkCard>
  <LinkCard title="Rust" href="/Low-Level/rust/comments">
